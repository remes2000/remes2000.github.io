...
}`]}),t})();const L=()=>["/"];let P=(()=>{var e;class t{constructor(){this.WEBSITE_DOMAIN=x}}return e=t,e.ɵfac=function(n){return new(n||e)},e.ɵcmp=c({type:e,selectors:[["app-nav"]],standalone:!0,features:[d],decls:5,vars:3,consts:[[1,"blog-name"],[3,"routerLink"]],template:function(n,a){n&1&&(r(0,"nav")(1,"div",0)(2,"a",1),C(3),i()(),s(4,"app-mode-switch"),i()),n&2&&(l(2),m("routerLink",u(2,L)),l(),f(a.WEBSITE_DOMAIN))},dependencies:[g,y],styles:[`nav[_ngcontent-%COMP%] {
  display: grid;
...
.social-media[_ngcontent-%COMP%]   a[_ngcontent-%COMP%]   svg[_ngcontent-%COMP%] {
  width: 100%;
  fill: var(--font-color);
}`]}),t})();const b=()=>["/"];let S=(()=>{var e;class t{constructor(){this.year=new Date().getFullYear()}}return e=t,e.ɵfac=function(n){return new(n||e)},e.ɵcmp=c({type:e,selectors:[["app-footer"]],standalone:!0,features:[d],decls:5,vars:3,consts:[[3,"routerLink"]],template:function(n,a){n&1&&(r(0,"footer")(1,"div")(2,"a",0),C(3),i()(),s(4,"app-social-media"),i()),n&2&&(l(2),m("routerLink",u(2,b)),l(),k("Michał Nieruchalski ",a.year,""))},dependencies:[g,O],styles:[`footer[_ngcontent-%COMP%] {
  text-align: center;
  padding: 5rem 0;
}
footer[_ngcontent-%COMP%]   a[_ngcontent-%COMP%] {
  color: var(--font-color);
  text-decoration: none;
}`]}),t})(),T=(()=>{var e;class t{}return e=t,e.ɵfac=function(n){return new(n||e)},e.ɵcmp=c({type:e,selectors:[["app-blog"]],standalone:!0,features:[d],decls:3,vars:0,template:function(n,a){n&1&&s(0,"app-nav")(1,"router-outlet")(2,"app-footer")},dependencies:[w,P,S],encapsulation:2}),t})();export{T as default};
